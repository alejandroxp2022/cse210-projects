...
class Pyranometer: MeteoDevice
{
    ...
    protected string _ModbusParams;
     ...
     // Constructors
    public Pyranometer(string deviceType, string deviceName, string deviceDesc, string IPaddress, string ModbusParams )
     {
   ...
   public string getStatus( string StreamConnection, string deviceId )
   {
    ...
    virtual public void CreatePyranometer()
    {
       // Console.Clear();
