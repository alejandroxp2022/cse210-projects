...
abstract class EnergyTransmit: EnergyEntity
{
    //fields
    ...
    protected string _ModbusParams;
     ...
     // Constructors
    public EnergyTransmit(string entityType, string entityName, string entityDesc, string IPaddress, string ModbusParams )
     {
